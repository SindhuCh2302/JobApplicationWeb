...
<%@ page import="com.sindhu.JobApp.model.JobPost" %>
<%@ page import="com.sindhu.JobApp.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://sindhuch2302.github.io/Sindhu_Chilukuri_porfolio/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
